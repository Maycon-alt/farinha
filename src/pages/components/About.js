...
export default function About(){
    return(
        <div id="historia" className=" w-full lg:h-[850px] bg-cover bg-center bg-no-repeat flex flex-col justify-end pb-10 sm:pb-32 py-32 lg:pb-[110px] pl-[50px] pr-[50px]">
            ...
            <div className="flex itens-start justify-between flex-col-reverse lg:flex-row">
                <div className="w-full lg:max-w-[530px] sm:pt-10 sm:text-center lg:text-left lg:pr-10 xl:pl-25">
                ...
                <div>
                    <Image className="rounded-2xl w-full h-full" width={800} height={800} src="/images/ngc.jpg" alt="foto carro"/>
                </div>
            </div>
        </div>
    )
