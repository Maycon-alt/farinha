...
export default function Footer(){
    return(
        ...
        <footer className="bg-white dark:bg-black rounded-2xl">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" className="flex items-center">
                        <Image src="/images/pokeball.png" width="30" height="30" className="h-8 mr-3 sm:h-10 w-10" alt="carrolouco" />
                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <ul className="text-gray-600 dark:text-gray-400 font-medium">
                            <li className="mb-4">
                                <a href="/" className="hover:underline">AutoElite</a>
                            </li>
                            <li>
                                <a href="https://tailwindcss.com/" className="hover:underline">Parceiros</a>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">AutoElite™</a>. Todos os direitos reservados.
                </span>
